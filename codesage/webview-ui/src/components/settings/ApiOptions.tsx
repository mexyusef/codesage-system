				...
				<div style={{ display: "flex", flexDirection: "column", rowGap: "5px" }}>
					...
					<Pane
						...
						<div
							...
							<p
								...
								Be careful for the model capabilities, as they can affect how Code-Sage can work.
							</p>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> Code-Sage uses complex prompts and works
