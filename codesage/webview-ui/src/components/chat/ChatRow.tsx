...
export const ChatRowContent = ({
			...
			case "mistake_limit_reached":
				return [
					<span
						className="codicon codicon-error"
						style={{ color: errorColor, marginBottom: "-1.5px" }}></span>,
					<span style={{ color: errorColor, fontWeight: "bold" }}>CodeSage is having trouble...</span>,
				]
			case "command":
				return [
					isCommandExecuting ? (
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						CodeSage wants to execute this command:
					</span>,
				]
			case "use_mcp_server":
				...
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						CodeSage wants to {mcpServerUse.type === "use_mcp_tool" ? "use a tool" : "access a resource"} on
			...
			case "followup":
				return [
					<span
						...
						style={{ color: normalColor, marginBottom: "-1.5px" }}></span>,
					<span style={{ color: normalColor, fontWeight: "bold" }}>CodeSage has a question:</span>,
				]
			default:
				return [null, null]
		}
	...
	if (tool) {
		...
		switch (tool.tool) {
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>CodeSage wants to edit this file:</span>
						</div>
						<CodeAccordian
			...
			case "newFileCreated":
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>CodeSage wants to create a new file:</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "CodeSage wants to read this file:"
									: "CodeSage read this file:"}
							</span>
						</div>
						{/* <CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "CodeSage wants to view the top level files in this directory:"
									: "CodeSage viewed the top level files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "CodeSage wants to recursively view all files in this directory:"
									: "CodeSage recursively viewed all files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "CodeSage wants to view source code definition names used in this directory:"
									: "CodeSage viewed source code definition names used in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										CodeSage wants to search this directory for <code>{tool.regex}</code>:
									</>
								) : (
									<>
										CodeSage searched this directory for <code>{tool.regex}</code>:
									</>
								)}
							</span>
						</div>
			...
			// 				<span style={{ fontWeight: "bold" }}>
			// 					{message.type === "ask" ? (
			// 						<>CodeSage wants to inspect this website:</>
			// 					) : (
			// 						<>CodeSage is inspecting this website:</>
			// 					)}
			// 				</span>
			// 			</div>
			// 			<div
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										CodeSage wants to switch to <code>{tool.mode}</code> mode
										{tool.reason ? ` because: ${tool.reason}` : ""}
									</>
								) : (
									<>
										CodeSage switched to <code>{tool.mode}</code> mode
										{tool.reason ? ` because: ${tool.reason}` : ""}
									</>
								)}
							</span>
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>
								CodeSage wants to create a new task in <code>{tool.mode}</code> mode:
							</span>
						</div>
					...
					return (
						<>
							<div
								...
								<div>
									CodeSage won't be able to view the command's output. Please update VSCode (
