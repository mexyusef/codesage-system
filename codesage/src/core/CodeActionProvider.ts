...
export const ACTION_NAMES = {
	EXPLAIN: "Code-Sage: Explain Code",
	FIX: "Code-Sage: Fix Code",
	FIX_LOGIC: "Code-Sage: Fix Logic",
	IMPROVE: "Code-Sage: Improve Code",
	ADD_TO_CONTEXT: "Code-Sage: Add to Context",
} as const
